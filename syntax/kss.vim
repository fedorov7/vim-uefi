...
syn keyword kssMacroMem     SAFE_FREE FREE_MEM_POINTER FREE_PAGES FREE_JSON_OBJECT JSON_OBJECT_FREE FREE_MEM_PAGES EFI_SIZE_TO_PAGES SET_VALUE
...
syn keyword kssMacroReturn  RETURN_IF_EFI_ERROR RETURN_IF_EFI_SUCCESS RETURN_IF_NULL RETURN_IF RETURN_EFI_STATUS RETURN_EFI_STRING RETURN_ASCII_STRING RETURN_HEX RETURN_INT RETURN_BOOLEAN RETURN_IF_NULL_EFI_STRING RETURN_BOOLEAN_IF RETURN_BOOLEAN_IF_NULL RETURN_POINTER RETURN_NULL_IF_NULL RETURN_POINTER_IF_NULL RETURN_POINTER_IF RETURN_NUMBER RETURN_NUMBER_IF RETURN_NUMBER_IF_NULL RETURN_NUMBER_IF_EFI_ERROR RETURN_POINTER_IF_EFI_ERROR RETURN_VOID_IF_EFI_ERROR RETURN_VOID_IF_EFI_SUCCESS RETURN_VOID_IF_NULL RETURN_VOID_IF RETURN_VOID_EFI_STATUS RETURN_NULL_IF_EFI_ERROR
