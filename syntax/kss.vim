...
syn keyword kssMacroExit    DBG_ENTER DBG_EXIT_STATUS DBG_EXIT_STRING DBG_EXIT DBG_EXIT_DEC DBG_EXIT_HEX DBG_EXIT_TF DBG_EXIT_ERROR DBG_EXIT_ASCII_STRING
syn keyword kssMacroReturn  RETURN_IF_EFI_ERROR RETURN_IF_EFI_SUCCESS RETURN_IF_NULL RETURN_IF RETURN_EFI_STATUS RETURN_EFI_STRING RETURN_ASCII_STRING RETURN_HEX RETURN_INT RETURN_BOOLEAN RETURN_IF_NULL_EFI_STRING
...
syn keyword uefiType        IN OUT BOOLEAN INT8 UINT8 INT16 UINT16 INT32 UINT32 INT64 UINT64 CHAR8 CHAR16 VOID LIST_ENTRY EFI_GUID EFI_STATUS EFI_HANDLE EFI_EVENT EFI_TPL EFI_LBA EFI_PHYSICAL_ADDRESS EFI_VIRTUAL_ADDRESS

syn match   kssType           "\M\<\(\u\|_\|\d\)\+\>"
